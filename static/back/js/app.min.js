...
$(document).ready(function() {
    ...
    $(".action-header__search")[0]) {
        ...
        $("body").on("click", ".action-header__toggle", function(a) {
            a.preventDefault(),
            c = $(this).closest(".action-header").find(".action-header__search"),
            c.fadeIn(300),
            c.find(".action-header__input").focus()
        }),
...
$(document).ready(function() {
    ...
    c.on("click", "[data-mae-action]", function(d) {
        ...
        switch (e) {
        case "block-open":
            b = $(this).data("mae-target"),
            $(b).addClass("toggled"),
            c.addClass("block-opened"),
            c.append('<div data-mae-action="block-close" data-mae-target="' + b + '" class="mae-backdrop mae-backdrop--sidebar" />');
            break;
        case "block-close":
            $(b).removeClass("toggled"),
            c.removeClass("block-opened"),
